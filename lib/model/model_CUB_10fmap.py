...
class Net(nn.Module):
    def __init__(self):
        ...
        #self.bn = nn.BatchNorm2d(1024, eps=1e-05, momentum=0.1, affine=True)
        ...
        self.conv_last = nn.Conv2d(2048, 2048, kernel_size=1, bias=False)
    ...
    def stn(self, x):
        ...
        #temp = F.relu(self.bn(self.conv_stn(temp)))
        temp = self.conv_stn(temp)
        return temp, theta
...
#self.grid_positions_is[0].detach(), H, x)
        ...
        return classif_scores, x, 0, all_boxes, theta
