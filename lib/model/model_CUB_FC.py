...
class Net(nn.Module):
    def __init__(self):
        ...
        #self.conv_stn2 = nn.Conv2d(2048, 201, kernel_size=3, stride=3)
    ...
    def forward(self, x, epoch, flag, log, batch_id=0, batch_size=4):
        ...
        x_flat = x.contiguous().view(-1, fmap*fmap*256)
        ...
        with torch.no_grad():
            all_boxes = box_utils.get_transformed_bounding_box_cub(self.box_pos, theta, classif_scores, batch_size, 
self.grid_positions_is[0], H, W, epoch, fmap, x)
