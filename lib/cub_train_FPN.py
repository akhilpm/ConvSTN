...
from model.model_FPN import Net
    ...
    with torch.no_grad():
        ...
        if indicator is None:
            ...
            if loca_acc > best_loc_acc1:
                ...
                torch.save(model.state_dict(), "/export/livia/Database/CUB_200_2011/model_FPN_ckpt.pth")
...
def main(log, args=None, arglist=None):
    ...
    parser.add_argument("-ir", "--image_res", type=int, help="image resolution", default=320)
    parser.add_argument("-lm", "--load_model", type=bool, help="load trained model or start training from scratch", default=False)
    ...
    model = Net().to(device)
    path_to_model = "/export/livia/Database/CUB_200_2011/model_FPN_ckpt.pth"
    if args.load_model:
...
if __name__=="__main__":
    ...
    fh = logging.FileHandler('running_FPN.log', mode='w')
